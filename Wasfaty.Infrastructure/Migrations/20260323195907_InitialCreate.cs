        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DispenseRecords_Pharmacies_PharmacyId",
                        column: x => x.PharmacyId,
                        principalTable: "Pharmacies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DispenseRecords_Pharmacists_PharmacistId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomMedicationName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomMedicationDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomDosageForm = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomStrength = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_PrescriptionItem_Medication", "([MedicationId] IS NOT NULL OR ([CustomMedicationName] IS NOT NULL AND [CustomMedicationDescription] IS NOT NULL))");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DispenseRecords_PharmacyId",
                table: "DispenseRecords",
                column: "PharmacyId");
